...
const NewProject = () => {
	...
	return (
		<div className="new-project">
			...
			<EtherscanInfo contractAddress={managerContractAddress} view="contract" type="Manager" />

			<EtherscanInfo contractAddress={managerContractAddress} view="transactions" type="Manager" />
